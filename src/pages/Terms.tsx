...
export function Terms() {
  return (
    <>
      <title>Términos y Condiciones | Pollos Tello&apos;s</title>
      <meta
        name="description"
        content="Conocé los términos y condiciones de uso de Pollos Tello&apos;s. Información sobre pedidos, pagos, zonas de entrega, datos personales y promociones."
      />
